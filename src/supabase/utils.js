...
const readLateData = async (rute, uuid) => {
    const res = await supabase
        .from(rute) //table name
        .select()
        .eq('sucursal', uuid)
...
export { onAuth, signUpWithEmailAndPassword, signInWithEmailAndPassword, signOut, passwordResset, passwordRedirect, writeUserData, readUserData, deleteUserData, updateUserData, readUserAllData, getUserData, getSpecificData, readUserDataEq, readLateData }
